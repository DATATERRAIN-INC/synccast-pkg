...
from synccast.exceptions.base import SyncCastError
from synccast.exceptions.codes import SyncCastErrorCode
...
class SyncCastAPIError(SyncCastError):
    ...
    Example:
        raise SyncCastAPIError(
            ...
            extra={"url": "https://synccast.io/api/topic", "status_code": 500}
        )
    """
